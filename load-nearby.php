	...
	<?php
		...
		if(mysqli_num_rows($nearby_result)>0)
		{
			while($nearby_row=mysqli_fetch_array($nearby_result))
			{
				...
				$nearby_user_id=$nearby_row['r_user_id'];
				...
				$bridge_query="SELECT * FROM users WHERE id='$nearby_user_id'";
						   ...
						   <div class="border network-list network-item rounded mb-3">
							  <div class="p-3 text-center">
								 ...
								 <div class="font-weight-bold">
									...
									<div class="small text-black-50"><?php echo $bridge_row['profile_title']; echo "<br/><b>".$distance." away</b>";if($bridge_row['profile_title']==""){ echo "<br/>"; } ?></div>
								 </div>
							  </div>
							  <?php
