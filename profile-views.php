									...
									?>
										 <a href="<?php echo base_url; ?>u/<?php echo $users_data['username']; ?>"><div class="p-3 d-flex align-items-center bg-light border-bottom osahan-post-header">
										   <div class="dropdown-list-image mr-3">
											 <img class="rounded-circle" src="<?php echo getUserProfileImage($viewer_id); ?>" alt="<?php echo $users_data['first_name']." ".$users_data['last_name']; ?>">
											  <div class="status-indicator <?php echo $active_status; ?>"></div>
										   </div>
										   <div class="font-weight-bold">
											  <div class="text-truncate"><?php echo $users_data['first_name']." ".$users_data['last_name']; ?><span style="float:right;"><?php echo date("M d Y h:i a",strtotime($views_row['added'])); ?></span></div>
											  <div class="small"><?php echo substr($users_personal_data['about'],0,100).".."; ?></div>
										   </div>
										</div></a>
									<?php
								}
								...
								if($earlier_num_rows>0)
								{
									while($earlier_row=mysqli_fetch_array($recent_profile_views_result))
									{
										...
										<a href="<?php echo base_url; ?>u/<?php echo $users_data['username']; ?>"><div class="p-3 d-flex align-items-center bg-light border-bottom osahan-post-header">
										   ...
										   <div class="font-weight-bold">
											  <div class="text-truncate"><?php echo $users_data['first_name']." ".$users_data['last_name']; ?><span style="float:right;"><?php echo date("M d Y h:i a",strtotime($earlier_row['added'])); ?></span></div>
